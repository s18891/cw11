    ...
    public partial class all : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, "xxxx@gmail.com", "Adam", "Kowalski" });

            migrationBuilder.InsertData(
                table: "Medicament",
                columns: new[] { "IdMedicament", "Description", "Name", "Type" },
                values: new object[] { 1, "Lek1 xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx.", "Lek1", "Lek xxxx" });

            migrationBuilder.InsertData(
                table: "Patient",
                columns: new[] { "IdPatient", "Birthdate", "FirstName", "LastName" },
                values: new object[] { 1, new DateTime(1980, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Tomasz", "Tomaszewski" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, 1, "xxxxxxxxxxxxxxxxxxx", 0 });
